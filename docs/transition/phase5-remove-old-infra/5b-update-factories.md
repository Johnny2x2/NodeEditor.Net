# 5B — Update Factories (VariableNodeFactory, EventNodeFactory)

> **Parallelism**: Can run in parallel with **5A** and **5C**.

## Prerequisites
- **Phase 1** complete (`ExecutionSocket.TypeName` exists)

## Can run in parallel with
- **5A** (Delete Old Files), **5C** (Reference Cleanup)
